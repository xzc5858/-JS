...
var FileCount = getQueryVariable("FileCount");
var norurl = "files/WsImgs/" + type + "/" + caseid + "/";
var larurl = "files/WsImgs/" + type + "/" + caseid + "/";;
//alert(norurl);
//alert(larurl);
...
bookConfig.totalPageCount = FileCount;   ///…Ë÷√“≥ ˝
...
bookConfig.normalPath = "files/WsImgs/" + type + "/" + caseid + "/";
bookConfig.largePath = "files/WsImgs/" + type + "/" + caseid + "/";
...
var pageEditor = { "setting": {}, "pageAnnos": [fk] };
